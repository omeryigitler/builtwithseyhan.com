...
const en = {
  ...
  signOut: 'Sign out',
  loading: 'Loading…',
  tabs: { posts: 'Posts', recipes: 'Recipes', members: 'Members', social: 'Social Wall', settings: 'Settings' },
  saving: 'Saving…',
  save: 'Save',
  saved: 'Saved',
  add: 'Add',
...
const tr: typeof en = {
  ...
  signOut: 'Çıkış',
  loading: 'Yükleniyor…',
  tabs: { posts: 'Gönderiler', recipes: 'Tarifler', members: 'Üyeler', social: 'Sosyal Duvar', settings: 'Ayarlar' },
  saving: 'Kaydediliyor…',
  save: 'Kaydet',
  saved: 'Kaydedildi',
  add: 'Ekle',
