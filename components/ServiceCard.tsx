...
export const ServiceCard: React.FC<ServiceCardProps> = ({ service, onClick }) => {
  return (
    <div 
        onClick={onClick}
        className="group relative w-full h-[340px] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-[2.5rem] shadow-[0_2px_8px_rgba(0,0,0,0.04)] dark:shadow-[0_2px_8px_rgba(0,0,0,0.2)] hover:shadow-[0_12px_24px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_12px_24px_rgba(204,255,0,0.1)] hover:border-brand/50 dark:hover:border-brand/50 transition-all duration-500 ease-out cursor-pointer overflow-hidden"
    >
        {/* Default Content: Icon & Title */}
        <div className="absolute inset-0 flex flex-col items-center justify-center p-8 transition-all duration-500 ease-out group-hover:opacity-0 group-hover:scale-90 group-hover:-translate-y-4">
            <div className="relative flex items-center justify-center w-28 h-28 bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-[1.5rem] mb-8 shadow-[inset_0_1px_4px_rgba(0,0,0,0.02)] group-hover:bg-brand/10 transition-colors">
                {/* Decorative Screws */}
                ...
                <div className="text-gray-800 dark:text-white group-hover:text-black dark:group-hover:text-brand transition-colors">
                    {service.icon}
                </div>
            </div>
        ...
        <div className="absolute inset-0 p-8 flex flex-col items-center justify-center text-center bg-white dark:bg-gray-900 opacity-0 translate-y-8 scale-95 transition-all duration-300 ease-out group-hover:opacity-100 group-hover:translate-y-0 group-hover:scale-100">
            ...
            <div className="mt-auto w-full flex flex-col items-center gap-4">
                ...
                <button className="flex items-center justify-center w-14 h-14 bg-brand text-black rounded-2xl shadow-lg hover:bg-brand-hover hover:scale-110 transition-all">
                    <ArrowRight size={24} />
                </button>
            </div>
        </div>
